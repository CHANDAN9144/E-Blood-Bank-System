...
<?php } ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Issue Blood</h4>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form  method="post" name="bloodgroup" action="issue_bloodgroup.php">
                     <div class="form-group">
                                            <label>Issue Blood Group</label>
                        ...
                        <hr />
                        <input type="submit" class="btn btn-info" value="Issue" onClick="return validateBloodGroup();"/>
